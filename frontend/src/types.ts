...
export interface AncestryAncestry {
  capacity: AncestryCapacity;
  description: string;
  name: string;
  size: string;
  type: string;
...
export interface AncestryCapacity {
  effects: string[];
  name: string;
}

export interface BackgroundBackground {
  abilities: string[];
  name: string;
  requirements: string;
}
...
export interface HandlerAncestriesList {
  ancestries: AncestryAncestry[];
}

export interface HandlerBackgroundsList {
  backgrounds: BackgroundBackground[];
}

export interface HandlerClassesList {
  classes: ClassClass[];
}

export interface HandlerHeroResponse {
  hero: HeroHero;
  id: string;
  sentence: string;
}
...
> extends HttpClient<SecurityDataType> {
  ancestries = {
    ...
    ancestriesList: (params: RequestParams = {}) =>
      this.request<HandlerAncestriesList, any>({
        path: `/ancestries`,
        method: "GET",
        format: "json",
        ...params,
    ...
    ancestriesDetail: (name: string, params: RequestParams = {}) =>
      this.request<AncestryAncestry, void>({
        path: `/ancestries/${name}`,
        method: "GET",
        format: "json",
        ...params,
      }),
  ...
  backgrounds = {
    ...
    backgroundsList: (params: RequestParams = {}) =>
      this.request<HandlerBackgroundsList, any>({
        path: `/backgrounds`,
        method: "GET",
        format: "json",
        ...params,
    ...
    backgroundsDetail: (name: string, params: RequestParams = {}) =>
      this.request<BackgroundBackground, void>({
  ...
  classes = {
    ...
    classesList: (params: RequestParams = {}) =>
      this.request<HandlerClassesList, any>({
        path: `/classes`,
        method: "GET",
        format: "json",
        ...params,
